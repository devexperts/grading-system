# How to Use the Grading System for Business Analysts

:zero: *Grades assessment* is a part of the PPR (Personal Performance Review). You can run this on demand during your one-on-one meetings with your manager, however, you can get a level up not more than once every six months.

    
:one: *The process*:

- Download the PPR form to your computer and fill it out using Microsoft Word.
...
- Grades self-assessment template description:
  - It contains the list of the skills required for each of the grades from BA2 to BA5.
...
:two: Check whether your self-assessment matches your Manager’s assessment:
   ...
   - Share access to your table with the Manager.
